...
export default function mypost(){
    ...
    useEffect(() => {
        ...
        const storedActualusername = sessionStorage.getItem('actualusername');
        if (storedActualusername) {
            setActualusername(storedActualusername);
        }
    }, []);
